...
namespace packer_strategy.Models.Plan
{
    ...
    public class Limit
    {
        ...
        public long BreadthThicknesses
        {
            get; set;
        }
